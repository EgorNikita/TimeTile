...
{
    public static readonly Dictionary<string, (System.Text.RegularExpressions.Regex Pattern, System.Text.RegularExpressions.Regex PostgresPattern, short MaxLength, string Description)> Patterns = new()
    {
        ["Title"] = 
