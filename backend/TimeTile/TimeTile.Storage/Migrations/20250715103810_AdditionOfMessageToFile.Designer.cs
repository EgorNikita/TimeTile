...
namespace TimeTile.Storage.Migrations
{
    ...
    [Migration("20250715103810_AdditionOfMessageToFile")]
    partial class AdditionOfMessageToFile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TimeTile.Core.Models.Message", b =>
                {
                    ...
                    b.ToTable("messages", null, t =>
                        {
                            t.HasCheckConstraint("CHK_Message_Edited_At_Valid", "\"edited_at\" IS NULL OR \"edited_at\" > \"sent_at\"");

                            t.HasCheckConstraint("CHK_Message_Sent_At_Valid", "\"sent_at\" < NOW()");
                        });
                });
