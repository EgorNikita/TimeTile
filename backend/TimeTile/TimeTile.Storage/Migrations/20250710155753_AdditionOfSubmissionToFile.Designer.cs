...
namespace TimeTile.Storage.Migrations
{
    ...
    [Migration("20250710155753_AdditionOfSubmissionToFile")]
    partial class AdditionOfSubmissionToFile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TimeTile.Core.Models.Submission", b =>
                {
                    ...
                    b.HasIndex("AssignmentId", "StudentId", "Status", "DeletedAt")
                        .IsUnique()
                        .HasDatabaseName("submissions_assignment_student_status_deleted_at_key");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("AssignmentId", "StudentId", "Status", "DeletedAt"), false);
