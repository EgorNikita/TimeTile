...
namespace TimeTile.Storage.Migrations
{
    ...
    [Migration("20250706172635_AdditionOfCourseToUser")]
    partial class AdditionOfCourseToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeTile.Core.Models.CourseToUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CourseId", "UserId", "DeletedAt")
                        .IsUnique()
                        .HasDatabaseName("courses_users_course_user_deleted_at_key");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("CourseId", "UserId", "DeletedAt"), false);

                    b.HasIndex("UserId", "OrderNumber", "DeletedAt")
                        .IsUnique()
                        .HasDatabaseName("courses_users_user_order_number_deleted_at_key");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("UserId", "OrderNumber", "DeletedAt"), false);

                    b.ToTable("courses_users", null, t =>
                        {
                            t.HasCheckConstraint("CK_CoursesUsers_OrderNumber_Positive", "\"order_number\" > 0");
                        });
                });
